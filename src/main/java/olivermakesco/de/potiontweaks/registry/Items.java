...
import olivermakesco.de.potiontweaks.item.BismuthItem;
...
public class Items {
    ...
    public static Item bismuth = new BismuthItem(new Item.Settings().group(PotionTweaksRegistry.potionTweaksGroup));
    public static Item bismuthOre = new BlockItem(Blocks.bismuthOre, new Item.Settings().group(PotionTweaksRegistry.potionTweaksGroup));
