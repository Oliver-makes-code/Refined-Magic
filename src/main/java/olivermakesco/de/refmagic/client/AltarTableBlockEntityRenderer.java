...
public class AltarTableBlockEntityRenderer implements BlockEntityRenderer<AltarTableBlockEntity> {
    ...
    private void drawItem(double offx, double offz, double offset, AltarTableBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay, long time, int slot) {
        matrices.push();
