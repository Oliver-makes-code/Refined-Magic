...
public class EnchantedHyphaeBlock extends PillarBlock {
    public final boolean stripped;
    public EnchantedHyphaeBlock(boolean stripped) {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        world.setBlockState(pos, RefinedMagicBlocks.strippedEnchantedHyphae.getDefaultState());
