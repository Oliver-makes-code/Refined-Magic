...
public class RefinedMagicRegistry {
    ...
    public static QuiltItemGroup items = QuiltItemGroup.builder(id("items")).appendItems(RefinedMagicPotions::appendStacks).icon(() -> RefinedMagicItems.kyriteShard.getDefaultStack()).build();
